...
class Table1Asha extends StatefulWidget {
  final int index;
  final ChildData childData;

  Table1Asha({required this.index, required this.childData});

  @override
  _Table1PageState createState() => _Table1PageState();
}

class _Table1PageState extends State<Table1Asha> {
  @override
  Widget build(BuildContext context) {
    ...
    //     MaterialPageRoute(
    //       builder: (context) =>
    //           Table1Asha(index: widget.index, childData: widget.childData),
    //     ),
    //   );
